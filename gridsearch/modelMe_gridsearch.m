function [out] = modelMe_gridsearch(P, ST, Z, ref)
%MODELME_V2 
%   INPUTS -
...
% reference point (stable parameter)
stableParam = ref;
...
[pFit, ~]=fminsearch(@(pFit)aFitLMNew(pFit,stableParam,r_xyh,r_xy,rCutOff,nBins),...
    pFitLM,options);

% get model-predicted firing rates for best-fit parameters
[R_xyh_model, fF] = get_Rxyh_model(pFit,stableParam,r_xyh,r_xy,rCutOff,nBins);
...
out.model.stableParams.xref = ref(1);
out.model.stableParams.yref = ref(2);
...
%% NESTED FUNCTIONS
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function [RXYHM, fF] = get_Rxyh_model(pFit,stableParam,rF,rP,rCutOff,Nbins)
    %   INPUTS--
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    function [fF] = aFitLMNew(pFit,stableParam,rF,rP,rCutOff,Nbins)
        % call the other function (optimization)
        [~, fF] = get_Rxyh_model(pFit,stableParam,rF,rP,rCutOff,Nbins);
    end
